...
module vcore_vld_issue_fifo #(
  ...
  input  vcore_vld_pkg::vcore_vld_decoded_t in_i,
  output logic                              out_valid_o,
  input  logic                              out_ready_i,
  output vcore_vld_pkg::vcore_vld_decoded_t out_o
);
  import vcore_vld_pkg::*;
  vcore_vld_decoded_t entries_q [DEPTH];
