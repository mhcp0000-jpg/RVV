module vcore_alu_issue_fifo #(
  ...
  input  vcore_alu_pkg::vcore_alu_decoded_t in_i,
  output logic                              out_valid_o,
  input  logic                              out_ready_i,
  output vcore_alu_pkg::vcore_alu_decoded_t out_o
);
  import vcore_alu_pkg::*;
  vcore_alu_decoded_t entries_q [DEPTH];
